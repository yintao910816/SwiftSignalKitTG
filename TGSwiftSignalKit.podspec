...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/yintao910816/TGSwiftSignalKitTG"
  ...
  spec.source       = { :git => "https://github.com/yintao910816/TGSwiftSignalKitTG.git", :tag => "#{spec.version}" }
