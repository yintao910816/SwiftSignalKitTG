...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/yintao910816/TGSwiftSignalKit"
  ...
  spec.source       = { :git => "https://github.com/yintao910816/TGSwiftSignalKit.git", :tag => "#{spec.version}" }
