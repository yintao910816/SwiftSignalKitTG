...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/yintao910816/SwiftSignalKitTG"
  ...
  spec.source       = { :git => "https://github.com/yintao910816/SwiftSignalKitTG.git", :tag => "#{spec.version}" }
